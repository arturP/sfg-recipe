package io.artur.spring.tutorial.mvc.sfgrecipe.bootstrap;

import io.artur.spring.tutorial.mvc.sfgrecipe.domain.*;
import io.artur.spring.tutorial.mvc.sfgrecipe.repositories.CategoryRepository;
import io.artur.spring.tutorial.mvc.sfgrecipe.repositories.RecipeRepository;
import io.artur.spring.tutorial.mvc.sfgrecipe.repositories.UnitOfMeasureRepository;
...
public class RecipeBootstrap implements ApplicationListener<ContextRefreshedEvent> {
    ...
    private UnitOfMeasure getUnitOfMeasureByDescription(String desc) {
        Optional<UnitOfMeasure> result = unitOfMeasureRepository.findByDescription(desc);
    ...
    private Category getCategoryByDescription(String desc) {

        Optional<Category> result = categoryRepository.findByDescription(desc);
